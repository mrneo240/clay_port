...
inputs *INPT_CurrentInput() { return &_current; }
...
bool INPT_Button(BUTTON btn) {
  switch (btn) {
    ...
    case BTN_START:
      ...
      break;
    default:
      return _current.btn_a || _current.btn_b || _current.btn_x ||
             _current.btn_y || _current.btn_start;
      break;
  }
  return false;
}
...
dpad_t INPT_DPAD() { return _current.dpad; }

bool INPT_DPADDirection(DPAD_DIRECTION dir) { return !!(_current.dpad & dir); }
